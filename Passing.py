...
player_names = []
players_data = []
my_url = 'https://fbref.com/en/comps/Big5/passing/players/Big-5-European-Leagues-Stats'
...
containers = page_soup.findAll("div", {"id": "all_stats_passing"})
...
###Export to Excel
df3.to_excel("Passing" + string[6] + ".xlsx", index=False)
