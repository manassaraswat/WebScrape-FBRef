...
player_names = []
players_data = []
my_url = 'https://fbref.com/en/comps/Big5/2019-2020/passing_types/players/2019-2020-Big-5-European-Leagues-Stats'
...
containers = page_soup.findAll("div", {"id": "div_stats_passing_types"})
...
###Export to Excel
df3.to_excel("PassingType" + string[6] + ".xlsx", index=False)
