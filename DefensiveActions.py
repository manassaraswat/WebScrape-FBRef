...
player_names = []
players_data = []
my_url = 'https://fbref.com/en/comps/Big5/defense/players/Big-5-European-Leagues-Stats'
...
containers = page_soup.findAll("div", {"id": "div_stats_defense"})
...
###Export to Excel
df3.to_excel("DefensiveActions" + string[6] + ".xlsx", index=False)
