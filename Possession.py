...
player_names = []
players_data = []
my_url = 'https://fbref.com/en/comps/Big5/possession/players/Big-5-European-Leagues-Stats'
...
containers = page_soup.findAll("div", {"id": "div_stats_possession"})
...
###Export to Excel
df3.to_excel("Possession" + string[6] + ".xlsx", index=False)
